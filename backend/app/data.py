...
_SEED: list[tuple[str, int, PatientStatus, str, str]] = [
    ("Lee Yuk-lan", 82, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Central"),
    ("Chan Ka-fai", 77, PatientStatus.attention, "Victoria Harbour Geriatric Care", "Wan Chai"),
    ("Cheung Suk-fong", 89, PatientStatus.urgent, "Lion Rock Outpatient Clinic", "Mong Kok"),
    ("Ho Kwok-ming", 74, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Tsim Sha Tsui"),
    ("Wong Mei-ling", 84, PatientStatus.stable, "Kowloon Care Collective", "Sheung Wan"),
    ("Chan Kwok-wah", 79, PatientStatus.attention, "Kowloon Care Collective", "Causeway Bay"),
    ("Pang Wai-kuen", 86, PatientStatus.stable, "Victoria Harbour Geriatric Care", "North Point"),
    ("Tang Wai-keung", 81, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Quarry Bay"),
    ("Lau Siu-fong", 88, PatientStatus.urgent, "Kowloon Care Collective", "Sham Shui Po"),
    ("Lam Foon-yee", 76, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Yau Ma Tei"),
    ("Tsang Mei-fong", 83, PatientStatus.attention, "Lion Rock Outpatient Clinic", "Kowloon City"),
    ("Yeung Chi-hung", 90, PatientStatus.stable, "Kowloon Care Collective", "Aberdeen"),
    ("Ng Pui-shan", 78, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Stanley"),
    ("Mak Chun-kit", 80, PatientStatus.attention, "Lion Rock Outpatient Clinic", "The Peak"),
    ("Cheung Wai-man", 85, PatientStatus.stable, "Kowloon Care Collective", "Central"),
    ("Choi Oi-lin", 87, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Wan Chai"),
    ("Ko Tin-yau", 73, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Causeway Bay"),
    ("Lo Yim-fong", 82, PatientStatus.urgent, "Kowloon Care Collective", "Tsim Sha Tsui"),
    ("Leung Ka-ho", 79, PatientStatus.stable, "Victoria Harbour Geriatric Care", "North Point"),
    ("Hui Lai-chu", 84, PatientStatus.attention, "Lion Rock Outpatient Clinic", "Sheung Wan"),
    ("Yip Lai-kuen", 91, PatientStatus.stable, "Kowloon Care Collective", "Mong Kok"),
    ("Au Kwok-on", 75, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Sham Shui Po"),
    ("Tang Shun-kei", 86, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Kowloon City"),
    ("Tam Suk-yee", 88, PatientStatus.attention, "Kowloon Care Collective", "Quarry Bay"),
    ("Fung Yuk-ying", 80, PatientStatus.stable, "Victoria Harbour Geriatric Care", "Yau Ma Tei"),
    ("Yuen Wing-fat", 83, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Aberdeen"),
    ("Sit Wing-chi", 77, PatientStatus.stable, "Kowloon Care Collective", "Stanley"),
    ("Kwok Yuet-wah", 89, PatientStatus.urgent, "Victoria Harbour Geriatric Care", "Causeway Bay"),
    ("Mo Chi-keung", 81, PatientStatus.stable, "Lion Rock Outpatient Clinic", "Central"),
    ("Tse Wai-han", 85, PatientStatus.attention, "Kowloon Care Collective", "Wan Chai"),
]
